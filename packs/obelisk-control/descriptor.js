...
const SYSTEM_PROMPT = [
    ...
    'When you have a response for the operator, reply as Markdown without running a command (use fenced Mermaid blocks only for diagrams). The workflow then waits for the operator to decide whether to continue, so replying is also how you ask the operator a question.',
