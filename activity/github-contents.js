...
// a link is a plain 404, so the website repo's `latest -> v0.41.x` docs alias
// would be invisible without rewriting. Listings surface symlinked directories
// like ordinary "dir" entries (the mounted repos only ever link directories);
// `list` and `read` then follow links until they reach a real tree or blob.
//
